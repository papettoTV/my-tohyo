    ...
    <section id="how-to-use" className="py-20 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl mb-4 text-slate-800">具体的な参加方法</h2>
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <h3 className="text-3xl text-slate-800">{method.title}</h3>
                  </div>
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-slate-500 uppercase tracking-wider">はじめ方</p>
                    <ul className="space-y-2">
                      {method.steps.map((step, stepIndex) => (
                        ...
                        >
                          <span className="flex-shrink-0 w-6 h-6 bg-slate-200 rounded-full flex items-center justify-center text-sm">
                            {stepIndex + 1}
                          </span>
                          <span>{step}</span>
                        </li>
