        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>投票した選挙の詳細情報を入力してください</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="house-representatives">衆議院議員総選挙</SelectItem>
                    <SelectItem value="house-councillors">参議院議員通常選挙</SelectItem>
                    <SelectItem value="governor">都道府県知事選挙</SelectItem>
                    <SelectItem value="mayor">市区町村長選挙</SelectItem>
                    <SelectItem value="local-assembly">地方議会議員選挙</SelectItem>
              ...
              <div className="space-y-2">
                ...
                <Input id="election-name" placeholder="例: 第50回衆議院議員総選挙" />
              </div>

              {/* Political Party */}
              <div className="space-y-2">
                <Label htmlFor="party">政党名</Label>
                <Input id="party" placeholder="例: 立憲民主党" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="notes" placeholder="投票理由や感想など..." rows={3} />
              </div>
